...
<body class="d-flex flex-column min-vh-100">
	...
	<!-- header -->
	<div class="top-header-area"  style="background-color: #051922; position: relative; mb-5"   id="sticker">
		<div class="container">
    ...
    <!-- footer -->
	<div class="footer-area mt-auto py-4" style="padding:20px;" dir="rtl">
		<div class="container">
			<div  class="row">
