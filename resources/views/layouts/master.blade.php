                ...
                <div class="col-lg-12 col-sm-12 text-center">
                    <div class="main-menu-wrap">
                        ...
                        <nav class="main-menu" dir="rtl">
                            <ul>
                                <li><a href="/">{{ __('words.main') }}</a></li>

                                {{-- <li><a href="/category">الاقسام</a></li> --}}
                                <li><a href="/products">{{ __('words.product page') }}</a></li>
                                {{-- <li><a href="/addproduct">اضافه منتج</a></li> --}}
                                <li><a href="/reviews"> {{ __('words.feedback') }}</a></li>
                                @auth
                                    @if (auth()->user()->role == 'admin')
                                        <li><a href="/datatable"> {{ __('words.dashboard') }}</a></li>
                                    @endif
                                @endauth
                                ...
                                @guest
                                    @if (Route::has('login'))
                                        <li>
                                            <a href="{{ route('login') }}">{{ __('words.log in') }}</a>
                                        </li>
                                    @endif

                                    @if (Route::has('register'))
                                        <li>
                                            <a href="{{ route('register') }}">{{ __('words.sign in') }}</a>
                                        </li>
                                    @endif
                                @else
                                    <li>
								...
								<li><a href="/">{{ app()->getLocale() == 'en' ? 'English' : 'العربية' }} ▾</a>
										<ul class="sub-menu">
